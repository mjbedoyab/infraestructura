...
class Inicio extends CI_Controller {
	...
	public function openCreateUser()
	{
		...
		$this->load->view('agrope/crearUsuario', $data);
	}
	...
	public function index(){
		...
		$this->load->view('agrope/inicio', $data);
	}
	...
	{
		$data['session'] = $this->session->userdata("session-mvc"); 
		$this->load->view('agrope/itemsA', $data);
	}
	...
	public function listaItemsA()
	{
		...
		$data['items'] = $this->ItemsModel->findBySede('AGROPECUARIO');

		$this->load->view('agrope/listaItemsA', $data);
	}
	...
	{
		$data['session'] = $this->session->userdata("session-mvc");
		$data['inventarios'] = $this->InventarioModel->findBySede('AGROPECUARIO');
		$this->load->view('agrope/inventarioA', $data);
	}

	public function openDeleteUsers()
	{
		$data['session'] = $this->session->userdata("session-mvc");
		$data['historials'] = $this->HistorialModel->findBySede('AGROPECUARIO');
		$this->load->view('agrope/historialA', $data);
	}
	...
	{
		$data['session'] = $this->session->userdata("session-mvc");
		$data['proyectos'] = $this->ProyectoModel->findAllsede();
		$this->load->view('agrope/listProyectA', $data);
	}
	...
	public function createEvidencia()
	{
		$data['session'] = $this->session->userdata("session-mvc");
		$data['proyectos'] = $this->ProyectoModel->findAllsede();
		$this->load->view('agrope/evidenciaA', $data);
	}
	...
	public function listEvidencias($id_proyecto = null) 
	{
		...
		$this->load->view('Agrope/listevidenciaA', $data);
	}
	...
	{
		$data['session'] = $this->session->userdata("session-mvc");
		$data['proyectos'] = $this->ProyectoModel->findAllsede(); // lista de proyectos
        $data['materiales'] = $this->InventarioModel->findBySede('AGROPECUARIO'); // lista de materiales
		$this->load->view('agrope/materialProyectA', $data);
	}
	...
	public function listarMaterialesProyecto($id_proyecto)
	{
		...
		$this->load->view('agrope/listarMaterialProyectA', $data);
	}
