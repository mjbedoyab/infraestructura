	...
	public function validarIngreso(){
		...
		if ($email!="" && $password!="") {
			...
			if ($validacion) {
				...
				}else if( $datosUsuario->tipo == "AGROPECUARIO" ){
					redirect('agrope/Inicio','refresh');
				}else if( $datosUsuario->tipo == "DESPACHO" ){
					redirect('despa/Inicio','refresh');
				}else if( $datosUsuario->tipo == "CENTRO" ){
					redirect('centro/Inicio','refresh');
				}else{
