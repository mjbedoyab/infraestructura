...
class Inicio extends CI_Controller {
	...
	public function index(){
		...
		$this->load->view('centro/inicio', $data);
	}
	...
	{
		$data['session'] = $this->session->userdata("session-mvc"); 
		$this->load->view('centro/itemsA', $data);
	}
	...
	public function listaItemsA()
	{
		...
		$data['items'] = $this->ItemsModel->findBySede('CENTRO');

		$this->load->view('centro/listaItemsA', $data);
	}
	...
	public function openListUsers()
	{
		$data['session'] = $this->session->userdata("session-mvc");
		$data['items'] = $this->ItemsModel->findBySede('CENTRO');
		$this->load->view('centro/materialA', $data);
	}

	public function openEditUsers()
	{
		$data['session'] = $this->session->userdata("session-mvc");
		$data['inventarios'] = $this->InventarioModel->findBySede('CENTRO');
		$this->load->view('centro/inventarioA', $data);
	}

	public function openDeleteUsers()
	{
		$data['session'] = $this->session->userdata("session-mvc");
		$data['historials'] = $this->HistorialModel->findBySede('CENTRO');
		$this->load->view('centro/historialA', $data);
	}
	...
	{
		$data['session'] = $this->session->userdata("session-mvc");
		$data['proyectos'] = $this->ProyectoModel->findAllsedeO();
		$this->load->view('centro/listProyectA', $data);
	}
	...
	public function createEvidencia()
	{
		$data['session'] = $this->session->userdata("session-mvc");
		$data['proyectos'] = $this->ProyectoModel->findAllsedeO();
		$this->load->view('centro/evidenciaA', $data);
	}
	...
	public function listEvidencias($id_proyecto = null) 
	{
		...
		$this->load->view('centro/listevidenciaA', $data);
	}
	...
	{
		$data['session'] = $this->session->userdata("session-mvc");
		$data['proyectos'] = $this->ProyectoModel->findAllsedeO(); // lista de proyectos
        $data['materiales'] = $this->InventarioModel->findBySede('CENTRO'); // lista de materiales
		$this->load->view('centro/materialProyectA', $data);
	}
	...
	public function listarMaterialesProyecto($id_proyecto)
	{
		...
		$this->load->view('centro/listarMaterialProyectA', $data);
	}
