<?php 
  $dataHeader['titulo'] = "Subir Item";
  $this->load->view('layouts/header', $dataHeader); 
?>
<?php 
  $dataSidebar['session'] = $session;
  $dataSidebar['optionSelected'] = 'createItems';
...
<div class="content-wrapper">
    ...
    <div class="container py-5">
		...
		<form class="mx-auto" action="<?= base_url('index.php/admin/Items/createItems' . (isset($id_item) ? '/' . $id_item : '')) ?>" method="post">
