    ...
    <div class="container py-4">
			<div class="card shadow rounded-3 p-4">
				<h2 class="text-center mb-4 font-weight-bold">
					<?= isset($id_material) 
						? '<i class="nav-icon fa-solid fa-pencil" style="color: #0f58d7;"></i>  EDITAR MATERIAL' 
						: '<i class="nav-icon fa-solid fa-box-open" style="color: #1962e1;"></i>  INGRESAR MATERIAL' 
					?>
				</h2>
				...
				<form class="row" action="<?= base_url('index.php/admin/Material/creatematerial' . (isset($id_material) ? '/' . $id_material : '')) ?>" method="post">
					...
					<div class="form-group col-md-6">
						...
						<select name="campo_nombre_material" id="campo_nombre_material" class="form-control select-buscador" required>
