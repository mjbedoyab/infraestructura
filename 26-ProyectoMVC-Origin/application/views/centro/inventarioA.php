...
<!-- Content Wrapper. Contains page content -->
 <div class="content-wrapper">
		<div class="col-12 m-0 p-3">
			<h2 class="text-primary text-center"><i class="fa-solid fa-boxes-stacked" style="color: #0548bd;"></i> INVENTARIO DE MATERIALES DISPONIBLES</h2>
		</div>
						...
						<div class="col-12">
							...
							<div class="card">
								<div class="card-header">
									<h3 class="card-title"><i class="fa-solid fa-boxes-stacked" style="color: #0548bd;"></i> MATERIALES</h3>
								</div>
								<!-- /.card-header -->
												...
												<?php foreach ($inventarios as $key => $inventario) : ?>
													<tr>
														...
														<td class="text-center">
															<a href="<?= base_url('index.php/centro/Material/creatematerial/' . $inventario->id_material) ?>" class="btn btn-outline-info">
																<i class="nav-icon fa-solid fa-pen-nib" style="color: #0d58d9;"></i>
															</a>
														</td>
														<td class="text-center">
															<a href="<?= base_url('index.php/centro/Material/borrar/' . $inventario->id_material) ?>" 
