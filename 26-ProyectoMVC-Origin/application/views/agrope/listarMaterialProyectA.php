					...
					<tbody>
						...
						<tr>
							...
							<td class="text-center">
							    <a href="<?= base_url('index.php/agrope/Proyecto/insertarMaterialProyecto?id_proyecto=' . $mp->id_proyecto . '&id_material=' . $mp->id_material) ?>"
							...
							<td class="text-center">
							<a href="<?= base_url('index.php/agrope/Proyecto/borrarMaterialProyecto/'  . $mp->id_proyecto . '/' . $mp->id_material) ?>" 
