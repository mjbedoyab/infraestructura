                                            ...
                                            <?php foreach ($proyectos as $proyecto) : ?>
                                                <tr>
                                                    ...
                                                    <td class="text-center">
                                                        <a href="<?= base_url('index.php/agrope/Inicio/listEvidencias/' . $proyecto->id_proyecto) ?>" class="btn btn-outline-primary">
                                                            <i class="nav-icon fa-solid fa-box-archive" style="color: #2aac39;"></i>
                                                        </a>
                                                    </td>
                                                    <td class="text-center">
                                                        <a href="<?= base_url('index.php/agrope/Inicio/listarMaterialesProyecto/' . $proyecto->id_proyecto) ?>" class="btn btn-outline-warning">
