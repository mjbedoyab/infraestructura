												...
												<?php foreach ($inventarios as $key => $inventario) : ?>
													<tr>
														...
														<td class="text-center">
															<a href="<?= base_url('index.php/agrope/Material/creatematerial/' . $inventario->id_material) ?>" class="btn btn-outline-info">
																<i class="nav-icon fa-solid fa-pen-nib" style="color: #0d58d9;"></i>
															</a>
														</td>
														<td class="text-center">
															<a href="<?= base_url('index.php/agrope/Material/borrar/' . $inventario->id_material) ?>" 
