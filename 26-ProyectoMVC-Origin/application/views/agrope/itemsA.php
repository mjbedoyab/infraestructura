    ...
    <div class="container py-5">
		<h2 class="text-center mb-4 font-weight-bold">
			<?= isset($id_item) 
				...
				: '<i class="nav-icon fa-solid fa-sitemap" style="color: #0a4cbd;"></i>  INGRESAR ITEM' 
			?>
		</h2>
		...
		<form class="mx-auto" action="<?= base_url('index.php/agrope/Items/createItemsA' . (isset($id_item) ? '/' . $id_item : '')) ?>" method="post">
